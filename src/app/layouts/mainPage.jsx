    ...
    <>
      <div>
        ...
        <div className="mb-5 me-auto ms-auto" style={ {maxWidth: '65rem'}}>
          <h1>Всем привет 👋</h1>
          <p className="fs-4">
            Мы - команда начинающих (и не очень 😉) JavaScript-разработчиков! У нас разные взгляды на жизнь
             и практический опыт, но всех нас объединяет одно - стремление к знаниям и любовь к разработке!
          </p>
        </div>
      </div>
